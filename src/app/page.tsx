...
const projects = [
  ...
  {
    title: "Mesa Marie Photography - Full Stack Portfolio",
    description: "A professional full-stack photography portfolio for NWPA photographer Mesa Marie, specializing in seniors, couples, families, and mini sessions. Features an admin gallery dashboard with Supabase authentication and Cloudinary image management, dynamic image galleries with lightbox, glass morphism UI effects, Formspree contact integration, and mobile-first responsive design.",
    category: "Photography Portfolio",
    status: "Live",
    gradient: "from-sky-400 to-blue-500",
    image: "/images/projects/mesa-photpgraphy.png",
    technologies: ["Next.js 16", "TypeScript", "Supabase", "Cloudinary", "Tailwind CSS", "Framer Motion", "Formspree"],
  ...
  },
  {
    ...
    description: "A professional business website for Tom Torrance Heating & Cooling, a family and veteran-owned HVAC company serving Erie County, PA for over 40 years. Features service showcases for AC, furnace, ductwork, and water heaters, seasonal maintenance scheduling, customer reviews integration, and a contact form for service requests.",
    category: "Business Website",
    status: "Live",
    gradient: "from-blue-600 to-red-600",
    image: "/images/projects/TomTorrance.png",
    technologies: ["Next.js", "JavaScript", "Tailwind CSS", "Responsive Design"],
    liveLink: "https://www.tomtorranceheatingcooling.com/",
    githubLink: "https://github.com/Jt-schofield1/TomTorranceWebsite",
    featured: false,
  },
  {
    title: "Rochester Foam Dart League",
    description: "A modern, mobile-first website for Rochester Foam Dart League (Foam Dart Nation Est. 2015) offering Nerf birthday parties, weekly games, and special events in Rochester, Buffalo, and Syracuse. Features a digital waiver system with signature capture, party booking inquiry forms, newsletter signup, and bold animated design.",
    category: "Business Website",
    status: "Live",
    gradient: "from-red-600 to-yellow-500",
    image: "/images/projects/FoamDart.png",
    technologies: ["Next.js 14", "TypeScript", "Tailwind CSS", "Framer Motion", "Formspree", "shadcn/ui"],
    liveLink: "https://rochester-foam-darts.vercel.app/",
    githubLink: "https://github.com/Jt-schofield1/RochesterFoamDarts",
    featured: false,
  },
  {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <a 
                  href="/resume/James-Schofield-Full Stack Developer , AI Professional.pdf" 
                  download="James-Schofield-Full Stack Developer , AI Professional.pdf"
